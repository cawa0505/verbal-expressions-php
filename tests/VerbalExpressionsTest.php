...
class VerbalExpressionsTest extends PHPUnit_Framework_TestCase
{
    ...
    */
    public function testMatch()
    {
        ...
        $shouldMatch = 'https://www.google.com http://google.com this is some test text';
        $shouldFail  = 'hello universe!';
        ...
        ], $regex->match($shouldMatch));

        $this->assertEquals([], $regex->match($shouldFail));
        }
}
